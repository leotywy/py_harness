...
"""
    ...
    # Plan mode prompt for long-running tasks with state externalization
    PLAN_MODE_PROMPT = """
...
"""
    ...
    def __init__(self, work_dir: str, plan_mode: bool = False) -> None:
        """Initialize with work directory and plan mode.
    ...
    def build(self) -> Message:
        ...
        if self.plan_mode:
            prompt_parts.append(self.PLAN_MODE_PROMPT)
